...
in [design 0002](https://github.com/smorinlabs/blueprint-press-dryrun/blob/main/docs/design/0002-web-api-conventions.md)
...
[EXAMPLEWEB.md](https://github.com/smorinlabs/blueprint-press-dryrun/blob/main/EXAMPLEWEB.md).
...
python -m blueprint_press_dryrun.web # production-shaped runner
