...
project = 'blueprint-press-dryrun'
copyright = '2026, Steve Morin'
author = 'Steve Morin'
# Single-sourced from pyproject.toml [project] version via the installed
# package metadata (blueprint_press_dryrun.__version__); never hardcode here.
release = __version__
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/smorinlabs/blueprint-press-dryrun",
            "html": """
...
html_logo = "_static/blueprint_press_dryrun_logo_100x100.png"
