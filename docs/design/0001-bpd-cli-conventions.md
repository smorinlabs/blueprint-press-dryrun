...
- **Created:** 2026-06-09
- **Applies to:** the blueprint-press-dryrun CLI (`bpd`)
...
`blueprint-press-dryrun` CLI. App short name: **`bpd`**. Environment variable
prefix: **`BPD`**.
...
## Appendix D — Migration notes for `blueprint-press-dryrun`
